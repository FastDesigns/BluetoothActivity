...
public class ServicesSearch {
    ...
    private static UUID HANDS_FREE = new UUID(0x111E);
    /* Get URL attribute from bluetooth service */
    private static int URL_ATTRIBUTE = 0X0100;
    static Vector<String> macAddresses = new Vector<String>();
...
//                            System.out.println("temporaryString: " + rd.getBluetoothAddress());//yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
//                            macAddresses=macAddresses+(rd.getBluetoothAddress()+" ");
                            macAddresses.add(rd.getBluetoothAddress());
                        }   
                    }
                }
